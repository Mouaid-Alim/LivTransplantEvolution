...
*prepareData* Prepares and cleans up raw clinical serum blood test result results for a single patient to extract Liver transplantation relevant clinical serum biomarkers, specifically those used in the MELD score calculations.
...
*visualizeMELD* Creates 4 graphs. Three visuals of the  trajectory of all three 
searate MELD scores with the biomarker most impactful of their longirtudinal 
changes, as well as a fourth visual with all 3 MELD score evolutions together.
